...
module.exports = app => {
  ...
  router.delete('/user/deleteById/:id', controller.user.deleteById);
  ...
  router.delete('/customer/deleteById/:id', controller.customer.deleteById);
  ...
  router.delete('/bill/deleteById/:id', controller.bill.deleteById);
  ...
  router.delete('/carrier/deleteById/:id', controller.carrier.deleteById);
